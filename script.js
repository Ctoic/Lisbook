document.addEventListener("DOMContentLoaded", function () {
  ...
  // Integrate bot logic for user interaction
  ...
  function handleUserInput() {
    ...
    if (userInput) {
      ...
      // Bot logic for recommendations, summaries, and conversations
      if (userInput.toLowerCase().includes("recommend")) {
        const recommendations = recommendBooks(userInput);
        ...
        const summary = provideSummary(bookTitle);
        addBotMessage(summary);
      } else {
        const conversationResponse = engageInConversation(userInput);
