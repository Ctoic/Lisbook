...
document.addEventListener("DOMContentLoaded", function () {
 ...
 const editNameBtn = document.getElementById("edit-name");
    ...
    chatbotForm.onsubmit = async (e) => {
      ...
      try {
        const response = await fetch("https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=AIzaSyAG8Nnd_VYq9FYhhC-ASchvWxdfntzJBLQ", {
          method: "POST",
